...
If you are interested in conducting experiments on ETH-XGaze, MPIIFaceGaze, and Gaze360 datasets with the same normalization method [4], you can refer to our another [code repository](https://github.com/X-Shi/Data-Normalization-Gaze-Estimation).
